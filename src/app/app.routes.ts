...
export const routes: Routes = [
  {
    ...
    providers: [StateConfigs.displayReward, StateConfigs.heroesSelect, StateConfigs.gameBoard],
    children: [
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./components/game-entry-point/game-entry-point.component').then(
            c => c.GameEntryPointComponent,
          ),
      },
      {
        ...
        loadComponent: () =>
          import('./pages/gift-store/gift-store.component').then(c => c.GiftStoreComponent),
      },
      {
