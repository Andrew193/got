...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./modules/taverna/taverna.module').then(m => m.TavernaModule),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./modules/daily-boss/daily-boss.module').then(
            m => m.DailyBossModule
          ),
      },
      {
        ...
        loadComponent: () =>
          import('./pages/summon-tree/summon-tree.component').then(
            c => c.SummonTreeComponent
          ),
      },
      {
        ...
        loadComponent: () =>
          import(
            './components/game-entry-point/game-entry-point.component'
          ).then(c => c.GameEntryPointComponent),
      },
      {
        path: frontRoutes.giftStore,
        canActivate: [GiftGuard],
        loadComponent: () =>
          import('./pages/gift-store/gift-store.component').then(
            c => c.GiftStoreComponent
          ),
      },
      {
        path: frontRoutes.ironBank,
        loadComponent: () =>
          import('./pages/iron-bank/iron-bank.component').then(
            c => c.IronBankComponent
          ),
      },
    ],
  },
