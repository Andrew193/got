...
export class OnlineService {
  ...
  trackOnlineTimer() {
    ...
    timer(TIME.tenMinutesMilliseconds, TIME.tenMinutesMilliseconds).pipe(
      switchMap(() => this.userService.updateOnline({time: TIME.tenMinuteSeconds}, true) as Observable<any>)
    ).subscribe();
  }
